  ...
  def new_room_time(self, transition, attempts, tracker):
    ...
    self.emit('new_room_time', {
      ...
      'segment': {
        ...
        'prev_median_time': segment_stats.p50,
        'prev_best_time': segment_stats.p0,
        'prev_p25_time': segment_stats.p25,
        'prev_p75_time': segment_stats.p75,
      },
      'room_in_segment': {
        'attempts': room_in_segment_stats.num_attempts,
        'time': room_in_segment_stats.time,
        'prev_median_time': room_in_segment_stats.p50,
        'prev_best_time': room_in_segment_stats.p0,
        'prev_p25_time': room_in_segment_stats.p25,
        'prev_p75_time': room_in_segment_stats.p75,
      },
    })
